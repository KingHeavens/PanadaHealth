...
/**
 * 带进度安全webView(解决Android 4.0以下的WebView注入Javascript对象引发的安全漏洞)
 * 
 * @author Luoming
 */
...
public class ProgressWebView extends WebView {
	...
	private void init(Context context) {
		...
		mErrorView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
	...
	private class WebViewClientEx extends WebViewClient {
		...
		public void onPageFinished(WebView view, String url) {
			injectJavascriptInterfaces(view);
			// 已设置标题 优先显示已设置的
			if (dTitle!=null && !dTitle.equals(getResources().getString(R.string.app_name)))
				return;
		...
		public void onReceivedError(WebView view, int errorCode,
			...
			if(onPageLoadListener != null)
				onPageLoadListener.onReceivedError(view,errorCode,description,failingUrl);
	...
	/*	@Override
		public void onReceivedSslError(WebView view, SslErrorHandler handler, SslError error) {
			...
			//handler.proceed();
			JLog.e("getPrimaryError:"+error.getPrimaryError() + "getCertificate:" + error.getCertificate());
		}*/
	}
