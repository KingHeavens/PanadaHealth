package com.jws.pandahealth.component.more.view;
...
public class DateSelectorWheelView extends RelativeLayout implements
	...
	private void initLayout(Context context) {
		LayoutInflater.from(context).inflate(R.layout.view_set_dete_time, this,
				true);
...
//			date = DateUtil.TimeStamp3Date2(initTimeStamp);
//		}
...
//
    ...
    public String getSelectedDate() {
        return mSelectedYear + "-" + mSelectedMonth + "-" + mSelectedDay;
    }
	...
	public void onChanged(WheelView wheel, int oldValue, int newValue) {
		...
		case R.id.wv_date_of_year:
			trim = MoreUtil.splitDateString(wvYear.getCurrentItemValue())
					.trim();
			mSelectedYear = trim;
			if (isLeapYear(trim)) {
				if (currentMonth == 2) {
		...
		case R.id.wv_date_of_month:
			trim = MoreUtil.splitDateString(wvMonth.getCurrentItemValue())
					.trim();
			...
			case 12:
				...
				break;
			case 2:
				String yearString = MoreUtil.splitDateString(
		...
		case R.id.wv_date_of_day:
		    trim = MoreUtil.splitDateString(wvDay.getCurrentItemValue()).trim();
		    mSelectedDay = trim;
			break;
		}
	}
