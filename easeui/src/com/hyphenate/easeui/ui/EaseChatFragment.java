...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
     ...
     * change by zjj to close BaiDuLocation
     */
    ...
    protected void setListItemClickListener() {
        messageList.setItemClickListener(new EaseChatMessageList.MessageListItemClickListener() {
            ...
            public void onResendClick(final EMMessage message) {
                chatFragmentHelper.easeReSendMessage(message,messageList);
    ...
    protected void sendMessage(EMMessage message){
        ...
        //send message
        if(chatFragmentHelper != null){
            chatFragmentHelper.easeSendMessage(message);
    ...
    public interface EaseChatFragmentHelper{
        /**
         * add by zjj easeMobSendMessage
         * @param message
         */
        void easeReSendMessage(EMMessage message,EaseChatMessageList list);
        /**
         * add by zjj easeMobSendMessage
         * @param message
         */
        void easeSendMessage(EMMessage message);
        /**
